...
export const metadata: Metadata = {
  title: "Wärmepumpe & Heizung in Königsbrunn - Service vom HeizCenter",
  description:
  ...
  keywords: [
    ...
    "Solarthermie Königsbrunn",
    "HeizCenter Königsbrunn",
  ],
  alternates: {
    canonical: getCanonicalUrl("/standorte/koenigsbrunn"),
  },
};
...
const services: LocationService[] = [
  ...
  {
    title: "Solarthermie",
    description: "Solarthermie-Anlagen für Königsbrunn. Bis 70% KfW-Förderung.",
    icon: Sun,
    href: "/solar",
  },
];
    ...
    <>
      ...
      <BreadcrumbSchema
        items={[
          ...
          { name: "Königsbrunn", url: "/standorte/koenigsbrunn" },
        ]}
      />
      ...
      <section className="container py-16">
        <div className="max-w-4xl mx-auto prose prose-slate">
          ...
          <p className="text-lg text-slate-700 mb-6">
            ...
            rund um Heizung, Sanitär und Klimatechnik. Von unserem Bobingen-Büro
            erreichen wir Sie in Königsbrunn in nur 15 Minuten.
          </p>
