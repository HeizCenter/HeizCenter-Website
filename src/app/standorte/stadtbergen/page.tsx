...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    "Solarthermie Stadtbergen",
    "HeizCenter Stadtbergen",
  ],
  alternates: {
    canonical: getCanonicalUrl("/standorte/stadtbergen"),
  },
};
...
const services: LocationService[] = [
  {
    title: "Wärmepumpe",
    description: "Moderne Wärmepumpen für Stadtbergen. BEG-Förderung bis 70%.",
    icon: Zap,
    href: "/waermepumpe",
  },
  {
  ...
  {
    title: "Solarthermie",
    description: "Solarthermie-Anlagen für Stadtbergen. Bis 70% KfW-Förderung.",
    icon: Sun,
    href: "/solar",
  },
];
