...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    "Solarthermie Kaufbeuren",
    "HeizCenter Kaufbeuren",
  ],
  alternates: {
    canonical: getCanonicalUrl("/standorte/kaufbeuren"),
  },
};
...
const services: LocationService[] = [
  ...
  },
  {
    title: "Solarthermie",
    description:
      "Solarthermie-Anlagen für Kaufbeuren. Bis 70% KfW-Förderung. Warmwasser mit Sonnenenergie.",
    icon: Sun,
    href: "/solar",
  },
];
