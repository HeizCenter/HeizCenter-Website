...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    "Sanitär Neu-Ulm",
    "Klimaanlage Neu-Ulm",
    "Solarthermie Neu-Ulm",
    "HeizCenter Neu-Ulm",
  ],
  alternates: {
    canonical: getCanonicalUrl("/standorte/neu-ulm"),
  },
};
...
const services: LocationService[] = [
  {
    title: "Wärmepumpe",
    description: "Moderne Wärmepumpen für Neu-Ulm. BEG-Förderung bis 70%.",
    icon: Zap,
    href: "/waermepumpe",
  },
  {
  ...
  {
    title: "Solarthermie",
    description: "Solarthermie-Anlagen für Neu-Ulm. Bis 70% KfW-Förderung.",
    icon: Sun,
    href: "/solar",
  },
];
