...
export const metadata: Metadata = {
  ...
  keywords: ["Wärmepumpe Bad Wurzach", "Heizung Bad Wurzach", "Solarthermie Bad Wurzach"],
  alternates: {
    ...
    <>
      ...
      <BreadcrumbSchema
        items={[
          ...
          { name: "Bad Wurzach", url: "/standorte/bad-wurzach" },
        ]}
      />
      ...
      />
      <LocationHero name="Bad Wurzach" address="Schlüsselbergstraße 5, 88484 Gutenzell-Hürbel" phone={CONTACT.PHONE_DISPLAY} email={CONTACT.EMAIL} description="HeizCenter Service Bad Wurzach. Wärmepumpen und Heizung im Allgäu."
