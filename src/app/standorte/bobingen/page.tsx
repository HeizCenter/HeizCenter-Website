...
const services: LocationService[] = [
  {
    title: "Wärmepumpe",
    description:
      "Moderne Wärmepumpen für Bobingen und Umgebung. BEG-Förderung bis 70%. Energieeffizient und umweltfreundlich heizen.",
    icon: Zap,
    href: "/waermepumpe",
  },
  {
  ...
  },
  {
    title: "Solarthermie",
    description:
      "Solarthermie-Anlagen für Bobingen. Bis 70% KfW-Förderung. Warmwasser und Heizungsunterstützung mit Sonnenenergie.",
    icon: Sun,
    href: "/solar",
  },
];
