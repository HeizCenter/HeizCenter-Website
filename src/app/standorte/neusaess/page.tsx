...
export const metadata: Metadata = {
  title: "Wärmepumpe & Heizung in Neusäß - Service vom HeizCenter",
  description:
  ...
  alternates: {
    canonical: getCanonicalUrl("/standorte/neusaess"),
  },
};
...
const services: LocationService[] = [
  {
    title: "Wärmepumpe",
    description: "Moderne Wärmepumpen für Neusäß. BEG-Förderung bis 70%.",
    icon: Zap,
    href: "/waermepumpe",
  },
  {
  ...
  {
    title: "Solarthermie",
    description: "Solarthermie-Anlagen für Neusäß. Bis 70% KfW-Förderung.",
    icon: Sun,
    href: "/solar",
  },
];
