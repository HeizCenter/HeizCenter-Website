      ...
      <div className="container px-4">
        <div className="max-w-2xl mx-auto text-center">
          ...
          <div className="grid md:grid-cols-3 gap-4 mb-8">
            <Link
              href="/"
              className="bg-white hover:bg-slate-50 border-2 border-slate-200 rounded-lg p-6 transition-all duration-200 hover:border-blue-600 group"
            >
            ...
            <Link
              ...
              className="bg-white hover:bg-slate-50 border-2 border-slate-200 rounded-lg p-6 transition-all duration-200 hover:border-blue-600 group"
            >
              <Phone className="h-8 w-8 text-blue-600 mx-auto mb-3 group-hover:scale-110 transition-transform" />
            ...
            <Link
              ...
              className="bg-white hover:bg-slate-50 border-2 border-slate-200 rounded-lg p-6 transition-all duration-200 hover:border-blue-600 group"
            >
              <Search className="h-8 w-8 text-blue-600 mx-auto mb-3 group-hover:scale-110 transition-transform" />
          ...
          <div className="mt-6">
            <p className="text-sm text-slate-600">
              Oder besuchen Sie unsere <Link href="/" className="text-blue-600 hover:underline">Startseite</Link>
            </p>
          </div>
